...
*/
if($_SERVER['HTTP_HOST']==('server7'||'www.webmindsindia.com'))
{
	$baseUrl = 'http://'.$_SERVER['HTTP_HOST'].'/cote_dor_import/admin/ckfinder/userfiles/';
}
else
{
	$baseUrl = 'http://'.$_SERVER['HTTP_HOST'].'/admin/ckfinder/userfiles/';
}
/*

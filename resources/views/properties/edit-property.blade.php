                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-info" role="tabpanel" aria-labelledby="pills-select-tab">
                                            ...
                                            <div class="row">
                                                ...
                                                @switch($Property->UnitTypeID)
                                                {{-- Apartment --}}
                                                    @case(1)
                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                                        <label>Floor Number</label>
                                                            <select class="form-control" name="FloorNumber" disabled>
                                                            <option value="">Select</option>
                                                            @foreach (config('constants.FloorNumber') as $floorNumbers => $arabic)
                                                            <option value="{{ $floorNumbers }}" {{ ($Property->Floor == $floorNumbers)? "selected": "" }}> {{ $arabic  }}</option> 
                                                            @endforeach
                                                            </select>
                                                    </div>
                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                                        <label>Floor</label>
                                                            ...
                                                            <option value="">Select</option>
                                                            @foreach (config('constants.Floor') as $Floor)
                                                            <option value="{{ $Floor }}" {{ ($Property->Floor === $Floor)? "selected": "" }}> {{ $Floor  }}</option> 
                                                            @endforeach
                                                            </select>
                                                    </div>
                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                                    ...
                                                    @break
                                                    @case(8) {{--   Commercial Full Building --}}
                                                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                                        <label>Number of Floors</label>
                                                        <input type="text" name="NoFloors" class="form-control" value="{{ $Property->NoFloors }}" />
                                                    </div>
                                                ...
                                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12">
                                                    ...
                                                    <input type="text" class="form-control"  name="GuardContactNumber" value="{{ $Property->GuardContactNumber }}"/>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12">
                                                    ...
                                                    <div class="checkbox checkbox-primary">
                                                        <input id="checkbox3" class="styled" type="checkbox" name="IsEnable" @if($Property->IsEnable) checked @endif />
                                                        <label for="checkbox3">Is Enable</label>
                                                    </div>
                                                </div>
                                            </div>
                                            @else
                                            <div class="row">
                                                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-12" style=" pointer-events: none;
                                                opacity: 0.4;">

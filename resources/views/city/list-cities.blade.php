...
<div class="content-inner">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="float-left mt-2">
                                <div class="d-inline-flex align-items-center">
                                    <h1>Cities</h1><span class="font-size-16 font-wt-600 color-gray">{{ count($cities) }} Total</span>
                                    <ol class="bclink">
                ...
                <section class="commonbox center">
                    <div class="panel-body">
                        ...
                        <h3 class="font-size-18 font-wt-600">No cities available.</h3><br>
                    </div>
                </section>
                 @endif
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" class="table" id="datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('cities.edit',$citie->Guid) }}" class="btn btn-small btn-gold-lt" title="Edit Details"><i class="material-icons icon-2x">edit</i></a>

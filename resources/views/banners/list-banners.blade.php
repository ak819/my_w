...
<div class="content-inner">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="float-left mt-2">
                    <div class="d-inline-flex align-items-center">
                        <h1>Banners</h1><span class="font-size-16 font-wt-600 color-gray">{{ count($banners) }} Total</span>
                        <ol class="bclink">
    ...
    <section class="commonbox center">
        <div class="panel-body">
            ...
            <h3 class="font-size-18 font-wt-600">No banners available.</h3><br>
        </div>
    </section>
    @endif
    @if(count($banners) >=1) 
                ...
                <table width="100%" cellspacing="0" cellpadding="0" class="table" id="datatable">
                   ...
                   <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><img src="{{ URL::asset('uploads/banner/'.$banner->Image) }}" width="200px" /></td>
                             <td>
                                @if($banner->IsEnable == 1)
                                ...
                                <td>
                                    <form action="{{ route('banner.destroy',$banner->Guid)}}" method="post">
                                        <a href="{{ route('banner.edit',$banner->Guid) }}" class="btn btn-small btn-gold-lt" title="Edit Details"><i class="material-icons icon-2x">edit</i></a>
                                        @method('delete')
                                        @csrf

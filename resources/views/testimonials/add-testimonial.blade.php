    ...
    <div class="row">
        ...
        @if (count($errors) > 0)
            <div class="alert alert-danger animate__animated animate__fadeInDown"  role="alert">
                 <strong>Error</strong> An error occurred while adding the testimonial
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <textarea class="form-control description" name="Message" id="Message"></textarea>
                                 @error('Message')
                               <span class="error"  style="color:#F30;">{{ $message }}</span>
                                  @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                ...
                                <input type="text" class="form-control" name="CustomerNameAr" />
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <textarea class="form-control description" name="MessageAr"></textarea>
                                 @error('MessageAr')
                               <span class="error"  style="color:#F30;">{{ $message }}</span>
                                  @enderror
                            </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                ...
                                <input type="text" class="form-control" name="DesignationAr" />
                                 @error('DesignationAr')
                               <span class="error"  style="color:#F30;">{{ $message }}</span>
                                  @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                              <!--   <a href="" class="btn btn-medium btn-gold float-right">Save Info</a> -->
                               <button type="submit" class="btn btn-medium btn-gold" id="submit">Save Info</button>
                            </div>
                        </div>
                    </div>
                </div>

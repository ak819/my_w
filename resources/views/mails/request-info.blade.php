                                                                    ...
                                                                    <div style="border: 0px; padding-top: 0px; position: relative;">
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                                                            ...
                                                                            <tr>
                                                                                <td align='left'>
                                                                                    <p>
																						<strong>Hi {{ $data['agentname'] }},</strong><br/><br/>
                                                                                        You have received an enquiry on the property assigned to you. Following are the details of the user:<br /><br />
                                                                                        <strong>Property Id:</strong> {{ $data['propertyno'] }}<br /><br />

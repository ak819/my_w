                                                                            ...
                                                                            <tr>
                                                                                <td align='left'>
                                                                                    <p>
                                                                                        ...
                                                                                        You have received an enquiry from evaluation form page. Following are the details of the user:<br /><br />
                                                                                        ...
                                                                                        <strong>Built-up or Plot Area:</strong> {{ $data['Area'] }}<br />
                                                                                        <strong>Purpose of the Evaluation:</strong> {{ $data['Purpose'] }}<br />

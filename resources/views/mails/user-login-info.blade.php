                                                                            ...
                                                                            <tr>
                                                                                <td align='left'>
                                                                                    <p>
                                                                                        ...
                                                                                        Welcome to Homes Jordan. Your account has been created successfully. Use following details to begin with:<br /><br />
                                                                            ...
                                                                            <tr>
                                                                                <td align="center">
                                                                                    <table>
                                                                                        <tbody><tr>
                                                                                            <td>
                                                                                                <a target="{{  url(app()->getLocale().'/login')}}" href="#" class="link2" style="background:#AC8952; padding:10px 30px;-webkit-border-radius: 6px; -moz-border-radius: 6px; border-radius: 6px; color:#ffffff;">Login Now</a>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody></table>
                                                                                </td>

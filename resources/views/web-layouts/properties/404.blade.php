    ...
    <div class="container">
        <div class="row" lang="en" dir="ltr">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-center mt-5 animate__animated animate__fadeIn animate__slow">
                ...
                <h2 class="font-size-30 font-wt-600 pb-1">Property you are looking for is not available</h2>
                <h3 class="font-size-20 font-wt-500">We have other interesting options for you, check it out.</h3><br /><br />
                <a href="{{ url(app()->getLocale().'/search-properties') . '?' . http_build_query(['adt' => 'Sale']); }}" class="btn btn-medium btn-gold animate__animated animate__fadeIn animate__slow">Search Properties</a>

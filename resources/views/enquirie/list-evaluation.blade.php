...
@section('title','Evaluation-Enquiries')
@section('content')
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="float-left mt-2">
                                <div class="d-inline-flex align-items-center">
                                    <h1>Evaluation Enquiries</h1><span class="font-size-16 font-wt-600 color-gray">{{ count($enquiries) }} Total</span>
                                    <ol class="bclink">
                        ...
                        <div class="table-responsive animate__animated animate__fadeIn animate__slow">
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" class="table" id="ExportDatatable">
                                ...
                                <tr>
                                        ...
                                        <th class="show_excel">City</th>
                                        <th class="show_excel">Category</th>
                                        <th class="show_excel">Price</th>
                                        <th class="show_excel">Built-up or Plot Area</th>
                                        <th class="show_excel">Purpose of the Evaluation</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$enquirie->City}}</td>
                                        <td>{{$enquirie->Category}}</td>
                                        <td>{{$enquirie->Price}}</td>
                                        <td>{{$enquirie->Area}}</td>
                                        <td>{{$enquirie->Purpose}}</td>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('evaluation-enquiry.followup',$enquirie->Guid)}}" method="post">
                                                @csrf
                                                @method('PUT')
                                                @if ($enquirie->Isfollowed)
                                            ...
                                            <a href="{{ route('evaluation-enquiry.destroy',$enquirie->Guid)}}"  class="btn btn-small btn-red-lt delete" title="Delete"><i class="material-icons icon-2x">delete_outline</i></a>
                                            @endif
                                        </form> 
                                        </td>
            ...
            <div class="modal fade" id="AddNoteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('evaluation-enquiry.update') }}" method="post">
                            @csrf

                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="float-left mt-2">
                                <div class="d-inline-flex align-items-center">
                                    <h1>Contact Us Enquiries</h1><span class="font-size-16 font-wt-600 color-gray">{{ count($enquiries) }} Total</span>
                                    <ol class="bclink">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('contact-enquiry.followup',$enquirie->Guid)}}" method="post">
                                                @csrf
                                                @method('PUT')
                                                @if ($enquirie->Isfollowed)
                                            ...
                                            <a href="{{ route('contact-enquiry.destroy',$enquirie->Guid)}}"  class="btn btn-small btn-red-lt delete" title="Delete"><i class="material-icons icon-2x">delete_outline</i></a>
                                            @endif
                                        </form> 
                                        </td>
            ...
            <div class="modal fade" id="AddNoteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('contact-enquiry.update') }}" method="post">
                            @csrf

                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="float-left mt-2">
                                <div class="d-inline-flex align-items-center">
                                    <h1>Property Enquiries</h1><span class="font-size-16 font-wt-600 color-gray">{{ count($enquiries) }} Total</span>
                                    <ol class="bclink">
                        ...
                        <div class="table-responsive animate__animated animate__fadeIn animate__slow">
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" class="table" id="ExportDatatable">
                                ...
                                <tr>
                                        ...
                                        <th class="show_excel">Property</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('enquiries.update',$enquirie->Guid)}}" method="post">
                                                @csrf
                                                @method('PATCH')
                                                @if ($enquirie->Isfollowed)
                                            ...
                                            <a href="{{ route('distroyenquiries',$enquirie->Guid)}}"  class="btn btn-small btn-red-lt delete" title="Delete"><i class="material-icons icon-2x">delete_outline</i></a>
                                            @endif
                                        </form> 
                                        </td>
            ...
            <div class="modal fade" id="AddNoteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('editenquireynote') }}" method="post">
                            @csrf

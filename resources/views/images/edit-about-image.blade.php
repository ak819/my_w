...
<div class="content-inner">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="float-left mt-2">
                    <div class="d-inline-flex align-items-center">
                        <h1>Edit {{ $banner->Name }}</h1><span class="font-size-16 font-wt-600 color-gray"></span>
                        <ol class="bclink">
                            <li class="breadcrumb-item">
                                <a href="{{ route('admin') }}"><i class="bx bx-home-alt font-size-18 color-gold"></i></a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">
                                <a href="{{ route('about-images-list') }}">All Listing</a>
                            </li>
                ...
                <div class="float-right">
                    <a href="{{ route('about-images-list') }}" class="btn btn-medium btn-outline-gold ml-2 mr-2 float-right">Back</a>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        @endif
        <form action="{{ route('about-image.update',$banner->Guid) }}" method="post" enctype="multipart/form-data"> 
                   @csrf
                   @method('PUT')
            ...
            <div class="containerbox p-4 animate__animated animate__fadeIn animate__slow">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-8 col-sm-8 col-12">
                        <label>Image (500 X 500)&nbsp;<span class="color-red">*</span></label><br />
                         <span class="btn btn-gold btn-file">
                            Select File <input type="file" name="Image" id="Image" onchange="readImage(this)">
                        </span>
                        @if($banner->Image)
                        <img src="{{ URL::asset('uploads/aboutus/'.$banner->Image) }}" width="45%" class="float-right" id="image_preview" />
                        @else
